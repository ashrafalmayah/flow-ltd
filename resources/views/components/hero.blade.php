...
<p>{{ __("A Saudi company specialized in business and support services (maintenance, cleaning, and operation)") }}</p>
    ...
    <img class="absolute -left-1/4 -z-10 bottom-0 sm:-bottom-24 sm:w-96 select-none" src="{{ asset('assets/images/icon.svg') }}" alt="">
    <img class="absolute -right-24 top-0 sm:-top-24 sm:w-96 select-none" src="{{ asset('assets/images/icon.svg') }}" alt="">
</section>
