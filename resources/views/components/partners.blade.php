<section dir="ltr" x-data="{}" x-init="$nextTick(() => {
    ...
    class="inline-flex select-none my-8 h-32 w-full flex-nowrap overflow-hidden [mask-image:_linear-gradient(to_right,transparent_0,_black_128px,_black_calc(100%-200px),transparent_100%)]">
    <ul x-ref="logos"
