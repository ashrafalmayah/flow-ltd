    ...
    <nav class="relative mx-auto flex max-w-5xl items-center sm:justify-center py-4">
        <ul :class="mobileMenuActive ? 'rtl:!right-0 !left-0' : ''"
            ...
            <li @click="mobileMenuActive = false" class="sm:rounded-md bg-white text-primary hover:bg-background"><a
                    class="px-4 py-3 sm:py-1" href="#">{{ __('Home') }}</a></li>
            <li @click="mobileMenuActive = false" class="sm:rounded-md bg-white text-primary hover:bg-background"><a
                    class="px-4 py-3 sm:py-1" href="#services">{{ __('Our Services') }}</a></li>
            {{-- <li @click="mobileMenuActive = false" class="sm:rounded-md bg-white text-primary hover:bg-background"><a class="px-4 py-3 sm:py-1" href="#ksa-vision">{{ __("Kingdom Vision") }}</a></li> --}}
            <li @click="mobileMenuActive = false" class="sm:rounded-md bg-white text-primary hover:bg-background"><a
                    class="px-4 py-3 sm:py-1" href="#message">{{ __('Our Message') }}</a></li>
            <li @click="mobileMenuActive = false" class="sm:rounded-md bg-white text-primary hover:bg-background"><a
                    class="px-4 py-3 sm:py-1" href="#achievements">{{ __('Our Achievements') }}</a></li>
        </ul>
