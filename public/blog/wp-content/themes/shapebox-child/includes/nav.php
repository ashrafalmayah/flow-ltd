...
<header class="sticky top-0 z-50 w-full bg-white/95 backdrop-blur-md shadow-[0_1px_0_rgba(27,58,107,0.08)] py-3 text-navy font-rubik">
    <div class="max-w-7xl mx-auto px-6 lg:px-10 flex items-center justify-between">
        
        <!-- Logo -->
        <a href="/">
            <div class="flex items-center gap-3" dir="rtl">
                <svg width="44" height="44" viewBox="0 0 162.18495 162.18426" fill="none" class="text-navy" aria-hidden="true">
                ...
                <div class="leading-none text-right">
                    <div class="font-bold text-base text-navy">
                        شركة فلو المحدودة
                    </div>
                    <div class="text-[10px] tracking-[0.15em] uppercase mt-0.5 text-steel">
                        FLOW COMPANY LTD
                    </div>
                </div>
            </div>
        ...
        <div class="hidden md:flex items-center gap-8">
            <a href="/#" class="text-sm font-medium text-navy hover:text-navy/80 transition-colors duration-200">الرئيسية</a>
            <a href="/#services" class="text-sm font-medium text-navy hover:text-navy/80 transition-colors duration-200">خدماتنا</a>
            <a href="/#achievements" class="text-sm font-medium text-navy hover:text-navy/80 transition-colors duration-200">انجازاتنا</a>
            <a href="/#partners" class="text-sm font-medium text-navy hover:text-navy/80 transition-colors duration-200">شركائنا</a>
            <a href="/blog/" class="text-sm font-medium text-navy hover:text-navy/80 transition-colors duration-200">المدونة</a>
            <a href="/#contact" class="text-sm font-medium text-navy hover:text-navy/80 transition-colors duration-200">تواصل معنا</a>
            
            <!-- Language Switcher styled button -->
			<?php foreach(pll_the_languages(['raw' => 1]) as $lang): ?>
			<?php if($lang['slug'] == 'en'): ?>
				<a href="<?= $lang['url'] ?>" class="bg-navy text-white hover:bg-navy/90 text-xs font-semibold px-5 py-2 rounded-full transition-all duration-200">
					English
				</a>
			<?php endif; ?>
			<?php endforeach; ?>
        ...
        <button
            class="md:hidden p-2 rounded-lg transition-colors text-navy animate-pulse"
            @click="mobileMenuActive = !mobileMenuActive"
            aria-label="Toggle Menu"
        >
            <!-- Menu Icon -->
            <svg x-show="!mobileMenuActive" class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16M4 18h16" />
            </svg>
            <!-- Close Icon -->
            <svg x-show="mobileMenuActive" style="display: none;" class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div
        ...
        class="md:hidden overflow-hidden bg-white border-t border-navy/8"
        style="display: none;"
    >
        <div class="px-6 py-4 space-y-1">
            <a href="/#" @click="mobileMenuActive = false" class="flex items-center justify-between py-3 text-sm font-medium border-b border-navy/5 text-navy hover:text-navy-dark">
                الرئيسية
            ...
            <a href="/#services" @click="mobileMenuActive = false" class="flex items-center justify-between py-3 text-sm font-medium border-b border-navy/5 text-navy hover:text-navy-dark">
                خدماتنا
                <svg class="w-4 h-4 text-steel transform rotate-180" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"/></svg>
            </a>
            <a href="/#achievements" @click="mobileMenuActive = false" class="flex items-center justify-between py-3 text-sm font-medium border-b border-navy/5 text-navy hover:text-navy-dark">
                انجازاتنا
                <svg class="w-4 h-4 text-steel transform rotate-180" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"/></svg>
            </a>
            <a href="/#partners" @click="mobileMenuActive = false" class="flex items-center justify-between py-3 text-sm font-medium border-b border-navy/5 text-navy hover:text-navy-dark">
                شركائنا
                <svg class="w-4 h-4 text-steel transform rotate-180" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"/></svg>
            </a>
            <a href="/blog/" @click="mobileMenuActive = false" class="flex items-center justify-between py-3 text-sm font-medium border-b border-navy/5 text-navy hover:text-navy-dark">
                المدونة
                <svg class="w-4 h-4 text-steel transform rotate-180" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"/></svg>
            </a>
            <a href="/#contact" @click="mobileMenuActive = false" class="flex items-center justify-between py-3 text-sm font-medium border-b border-navy/5 text-navy hover:text-navy-dark">
                تواصل معنا
                <svg class="w-4 h-4 text-steel transform rotate-180" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"/></svg>
            </a>
			<?php foreach(pll_the_languages(['raw' => 1]) as $lang): ?>
			<?php if($lang['slug'] == 'en'): ?>
				<a href="<?= $lang['url'] ?>" class="flex items-center justify-between py-3 text-sm font-medium text-navy hover:text-navy-dark">
					<span>English</span>
					<svg class="w-4 h-4 text-steel transform rotate-180" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"/></svg>
				</a>
			<?php endif; ?>
