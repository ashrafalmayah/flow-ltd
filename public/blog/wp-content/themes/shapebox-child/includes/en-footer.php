        ...
        <div class="max-w-7xl mx-auto px-6 lg:px-10 text-center w-full">
            <div x-data="{ shown: false }" 
                ...
                <p class="mb-8 max-w-md mx-auto text-sm sm:text-base text-white/55">
                    We are pleased to serve you and answer your inquiries at any time
                </p>
    ...
    <div class="relative max-w-7xl mx-auto px-6 lg:px-10 py-10 md:py-6 z-10 w-full">
        <div class="grid md:grid-cols-3 gap-12 text-right rtl:text-right ltr:text-left">
            ...
            <div>
                ...
                <p class="mt-5 text-sm leading-relaxed max-w-xs text-white/45">
                    A company specialized in providing integrated services with the highest standards of quality and professionalism in the Kingdom of Saudi Arabia
                </p>
            </div>
            ...
            <div>
                ...
                <div class="space-y-3">
                    <a href="/en/#" class="block text-sm text-white/50 hover:text-white transition-colors duration-200">Home</a>
                    <a href="/en/#services" class="block text-sm text-white/50 hover:text-white transition-colors duration-200">Our Services</a>
                    <a href="/en/#achievements" class="block text-sm text-white/50 hover:text-white transition-colors duration-200">Our Achievements</a>
                    <a href="/en/#partners" class="block text-sm text-white/50 hover:text-white transition-colors duration-200">Our Partners</a>
                </div>
            </div>
        ...
        <div class="mt-8 md:mt-4 pt-6 md:pt-4 border-t border-white/5 flex flex-col sm:flex-row items-center justify-between gap-4">
            <p class="text-xs text-white/25">
                All rights reserved © 2024 Flow Company Ltd
            </p>
